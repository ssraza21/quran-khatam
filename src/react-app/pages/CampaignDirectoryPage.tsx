                  ...
                  >
                    ...
                    <div className="mt-4 grid grid-cols-3 gap-2">
                      ...
                      <div className="rounded-xl bg-gray-50 px-2 py-2.5 text-center">
                        ...
                        <p className="mt-1 text-lg font-bold leading-none text-gray-700">{campaign.goal}</p>
                        <p className="mt-1 text-[9px] font-medium uppercase tracking-wide text-gray-500">Goal</p>
                      </div>
                    </div>

                    <div className="mt-auto pt-5">
                      <div className="mb-1.5 flex items-center justify-between text-[11px] text-gray-400">
                        <span>{campaign.completed_khatams} of {campaign.goal} completed</span>
